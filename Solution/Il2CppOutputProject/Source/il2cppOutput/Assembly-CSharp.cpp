...
IL2CPP_EXTERN_C String_t* _stringLiteral0B4B0E1754701A1675AA3B87021590AC0735AD4E;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void HololensEasyReaderSample_Update_m700BBAC47E39A4CFFE39AF6873E75BDD708C43C4 (HololensEasyReaderSample_t581D5CEFC54ED232826E6B8301966D2657117DC3* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral0B4B0E1754701A1675AA3B87021590AC0735AD4E);
		s_Il2CppMethodInitialized = true;
	}
	{
		float L_0;
...
IL_0015:
	{
		...
		Color32U5BU5D_t38116C3E91765C4C5726CE12C77FAD7F9F737259* L_4 = __this->___cameraColorData;
		NullCheck(L_3);
		...
		RuntimeObject* L_6 = __this->___barcodeReader;
		Color32U5BU5D_t38116C3E91765C4C5726CE12C77FAD7F9F737259* L_7 = __this->___cameraColorData;
		int32_t L_8 = __this->___width;
		int32_t L_9 = __this->___height;
		NullCheck(L_6);
		Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF* L_10;
		L_10 = InterfaceFuncInvoker3< Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF*, Color32U5BU5D_t38116C3E91765C4C5726CE12C77FAD7F9F737259*, int32_t, int32_t >::Invoke(0, IBarcodeReader_t7C5A059E4DA3A0B4F7FA68ABD7131229C8DFF1AB_il2cpp_TypeInfo_var, L_6, L_7, L_8, L_9);
		__this->___result = L_10;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___result), (void*)L_10);
		Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF* L_11 = __this->___result;
		if (!L_11)
		{
			goto IL_009d;
		}
	}
	{
		...
		__this->___lastScanTime = L_12;
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_13 = __this->___resultText;
		Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF* L_14 = __this->___result;
		NullCheck(L_14);
		String_t* L_15;
		L_15 = Result_get_Text_m65A52D001505F5311D513F3CDD86D3BB72103E89_inline(L_14, NULL);
		String_t* L_16;
		L_16 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(_stringLiteral0B4B0E1754701A1675AA3B87021590AC0735AD4E, L_15, NULL);
		NullCheck(L_13);
		VirtualActionInvoker1< String_t* >::Invoke(66, L_13, L_16);
		Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF* L_17 = __this->___result;
		NullCheck(L_17);
		String_t* L_18;
		...
		Result_tF578DE3ECC8EB51CFB66605B8ADCD433C837EBAF* L_19 = __this->___result;
		NullCheck(L_19);
		String_t* L_20;
		L_20 = Result_get_Text_m65A52D001505F5311D513F3CDD86D3BB72103E89_inline(L_19, NULL);
